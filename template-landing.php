	...
	<div id="template1">
        ...
        <div class="template1_post">
			<!--div id="noticias_detalle_img">
				...
				<?php echo get_post_meta(get_the_ID(), 'bases_landing', true);?>
			</div>
			...
			<div id="noticias_detalle_des">
  			...
  			<?php 
			$url_bases = get_post_meta(get_the_ID(), 'bases_landing', true);
 			
			if ($url_bases != ""){ ?>
            <a target="_blank" href="<?php echo $url_bases;?>">
            	<span class="pp_vermas">Ver bases legales</span>
            </a>
            <?php } ?>
         </div>   
