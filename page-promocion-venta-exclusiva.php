...
<div id="template1">
	...
	<?php if (have_posts()) : while (have_posts()) : the_post();?>
		<div class="template1_post">
			<?php the_content();?>
            <a href="http://www.salcobrand.cl/cl/wp-content/uploads/2012/02/bases_venta_especial_la_tercera.pdf" target="_blank"><span class="pp_vermas">Ver bases legales</span></a>
		</div>
	<?php endwhile; endif; ?>
</div>
