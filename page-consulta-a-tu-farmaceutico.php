	...
	<div id="contacto_intro">
            ...
            <div id="contacto_form">
            	<form id="form_contacto" action="?" method="post" onsubmit="return validarForm(this);">
                    ...
                    <div class="c_general">
                    	<span>Email</span>
                        <input type="text" name="email" value="<?php echo $user_data->user_email;?>" <?php 
                    ...
                    <div class="c_enviar">
                    	<input type="hidden" name="cms_salco" value="consulta"/>
                    	<input type="submit" value="" />
                    </div>
                </form>
            </div>
        </div>
        <?php if(status_consulta()== "exito"){?>
			<!--script type="text/javascript">
			jQuery(document).ready(function(){
				show_alert("&igrave;Gracias!", "Tu consulta ha sido enviado correctamente");
			});
			</script-->
		...
		<?php }elseif(status_consulta()){?>
			<!--script type="text/javascript">
			jQuery(document).ready(function(){
				show_alert("&igrave;Atenci&oacute;n!", "");
			});
			</script-->
			...
			jQuery(document).ready(function(){
				...
				jQuery("#alerta_header a").attr("href", "#");
				jQuery("#alerta_wrap p").html("<?php echo status_consulta();?>");
				jQuery("#alerta_wrap").show();
			});
			</script>
