            ...
            if(error == 0){
                jQuery.ajax({
                    ...
                    success: function(datos){
                        _gaq.push(['_ trackPageview', 'CampanaRegistro', 'Clienteenviado']);
...
<div id="contenedorform-familia">
    ...
    <div style="padding: 90px 0 0 318px; position: absolute;"><img src="<?php echo URL_THEME;?>/campana-registro/images/txt-act.png" /></div>
<!-- loading -->
...
<div class="contenidoform-familia">
    ...
    <div class="columna-formulario">
    	<form id="fm_registro">
        <ul>
        	<li><label class="span200">Rut (ej. 12346567-8)</label><input name="rut" type="text" id="rut" maxlength="10" value="<?php echo $current_user->user_login; ?>"><span id="uno" class="b-error"><img src="<?php echo URL_THEME;?>/campana-registro/images/error.png" /></span><!--<img src="<?php echo URL_THEME;?>/campana-registro/images/rut-valido.png" width="27" height="27" class="verificador">--></li><br class="limpiar">
        	<li class="hidden"><label class="span200">Nombre</label><input name="nombre" type="text" id="nombre" maxlength="50" value="<?php echo $current_user->primer_nombre; ?>"><span id="dos" class="b-error"><img src="<?php echo URL_THEME;?>/campana-registro/images/error.png" /></span></li><br class="limpiar">
            <li class="hidden"><label class="span200">Apellido</label><input name="apellido_paterno" type="text" id="apellido" maxlength="50" value="<?php echo $current_user->apellido_paterno; ?>"><span id="tres" class="b-error"><img src="<?php echo URL_THEME;?>/campana-registro/images/error.png" /></span></li><br class="limpiar">
            <li class="hidden"><label class="span200">Email</label><input name="email" type="text" id="email" maxlength="50" value="<?php echo $current_user->user_email; ?>"><span  id="cuatro" class="b-error"><img src="<?php echo URL_THEME;?>/campana-registro/images/error.png" /></span></li><br class="limpiar">
            <li class="hidden"><label class="span200">Celular</label><input name="celular" type="text" id="celular" maxlength="8" value="<?php echo $current_user->telefono_celular; ?>"><span  id="cinco" class="b-error"><img src="<?php echo URL_THEME;?>/campana-registro/images/error.png" /></span></li><br class="limpiar">
        ...
        <input type="hidden" name="cms_salco" id="cms_salco" value="modificar_campanas" />
