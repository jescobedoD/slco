...
<div id="noticias">
    ...
    <div id="perfil_box">	
		...
		<div id="perfil_avatar_box">
			<div class="perfil_avatar">
				<img src="http://www.salcobrand.cl/cl/wp-content/themes/salcobrand/images/btn_perfil.png" width="26" height="27" alt="" class="btn_perfil"/>
	...
	<div id="cajas_puntos">
		<?php $descuento = getCuponDcto(reset(explode('-',$current_user->user_login)),end(explode('-',$current_user->user_login)));
			...
			<a href="javascript:void(0);" onclick="_gaq.push(['_trackEvent', 'Sitio Privado', 'imprimir descuento ']);" class="imprime_cupon"></a>
			</div>
			<?php endif; ?>
			...
			?>
				<div class="texto_puntos">
					<p>Puntos Disponibles: <?php echo $puntos[0];?></p>
					<p>Puntos Acumulados: <?php echo $puntos[1];?></p>
					<p>Puntos por Vencer: <?php echo $puntos[2];?></p>
				</div>
			</div>	
	</div>
	<!-- FIN CAJAS DSCTO/PUNTOS -->
