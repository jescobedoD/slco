...
//$_POST = clean_array_for_post($_POST);
//$_GET = clean_array_for_post($_GET);
...
if(!function_exists('salco_registro')){
	function salco_registro(){
		...
		if(isset($_POST)){
			...
			###########################################
			### MODIFICADO PARA EL LIGHTBOX DE REGISTRO
			###########################################
			...
			if($_POST['origen']){
				...
				$set = Array(
					'rut'				=> reset(explode('-',$_POST['rut'])),
					'DV'				=> end(explode('-',$_POST['rut'])),
					'primer_nombre'		=> $_POST['nombre'],
					'apellido_paterno'	=> $_POST['apellido_paterno'],
					'fecha_nacimiento'	=> $_POST['dia']."-".$meses[$_POST['mes']]."-".$_POST['ano'],
					'email'				=> $_POST['email'],
													...
													<table border="0" cellpadding="0" cellspacing="0" width="580" id="templateHeader">
														<tr>
															<td class="headerContent">
																<map name="foto">
																	<area shape="rect" coords="240,245,67,280" href="http://www.salcobrand.com/" target="_blank">
																	<area shape="rect" coords="240,295,67,330" href="http://m.salcobrand.cl" target="_blank">
																	<area shape="rect" coords="500,245,267,280" href="http://www.facebook.com/salcobrand" target="_blank">
																	<area shape="rect" coords="500,300,267,335" href="http://www.twitter.com/salcobrand" target="_blank">
																</map>
																<!-- // Begin Module: Standard Header Image \\ -->
																<img style="max-width:600px;" align="left" src="http://www.wallaby-group.com/sec/salco/email-registro/fondo_email.jpg" usemap="#foto">
			...
			*/
			...
			$set = Array(
				...
				'telefono_fijo'		=> mysql_real_escape_string($_POST['tel_particular']),
				'telefono_celular'	=> mysql_real_escape_string($_POST['tel_celular']),
	...
	function salco_modificar(){
		...
		if	($_POST['rut_digito']!="admin1"){
			...
			*/
			...
			if($_GET['r']) $cms_oracle->actualizar2($set);
			else $cms_oracle->actualizar($set);
			...
			if($_GET['r']) $wp_error->add('registro_usuario', __('&iexcl;Tus datos han sido actualizados correctamente!<br />Ya est&aacute;s participando por el Mac Book Air y una de las 5 Tarjetas de Regalo de $50.000.<br />Invita a participar a tus amigos por Facebook  y aumenta tus posibilidades de ganar.<br /><br /><a href=\"javascript:void(0);\" onclick=\"newInvite();\"><img src=\"http://www.salcobrand.cl/cl/campana_registro/imagenes/respuesta_face2.png\"></a>'));
			else $wp_error->add('registro_usuario', __('exito'));
		}
	}
}
...
if(!function_exists('salco_referidos')){
							...
							<table border="0" cellpadding="0" cellspacing="0" width="580" id="templateContainer">
									...
									<td align="center" valign="top">
										...
										<table border="0" cellpadding="0" cellspacing="0" width="580" id="templateHeader">
											<tr>
												<td class="headerContent">
													<!-- // Begin Module: Standard Header Image \\ -->
													<img style="max-width:600px;" align="left" src="http://www.wallaby-group.com/sec/salco/email-registro/1.jpg" usemap="#foto">
													<!-- // End Module: Standard Header Image \\ -->
								...
								<tr>
									<td align="left" valign="top">
										<!-- // Begin Template Header \\ -->
										<table border="0" cellpadding="0" cellspacing="0" width="568" id="templateHeader">
											<tr>
												<td class="headerContent" style="background-color:#00a6de; text-align:center;">
													<font style="color:white; font-size:34px; font-family: \'Open Sans Condensed\', sans-serif;">Tu amiga <span>'.$nombre.'</span> te invita a</font>
													</br>
													<font style="color:white; font-size:34px; font-family: \'Open Sans Condensed\', sans-serif;">&quot;Inscr&iacute;bete y Gana&quot;</font>
												</td>
											</tr>
										</table>
										<!-- // End Template Header \\ -->
									...
									<td align="center" valign="top">
										...
										<table border="0" cellpadding="0" cellspacing="0" width="580" id="templateHeader">
											<tr>
												<td class="headerContent">
													<map name="foto">
														<area shape="rect" coords="195,280,375,245" href="http://www.salcobrand.cl/" target="_blank">
														<area shape="rect" coords="240,365,67,330" href="http://www.salcobrand.cl/" target="_blank">
														<area shape="rect" coords="240,410,67,370" href="http://m.salcobrand.cl" target="_blank">
														<area shape="rect" coords="500,375,267,330" href="http://www.facebook.com/salcobrand" target="_blank">
														<area shape="rect" coords="500,410,267,375" href="http://www.twitter.com/salcobrand" target="_blank">
													</map>
													<!-- // Begin Module: Standard Header Image \\ -->
													<img style="max-width:600px;" align="left" src="http://www.wallaby-group.com/sec/salco/email-registro/2.jpg" usemap="#foto">
													<!-- // End Module: Standard Header Image \\ -->
	...
	wp_mail($_POST['email_amigo1'], 'Bienvenido a Salcobrand', $message, $headers);
	wp_mail($_POST['email_amigo2'], 'Bienvenido a Salcobrand', $message, $headers);
	wp_mail($_POST['email_amigo3'], 'Bienvenido a Salcobrand', $message, $headers);		
